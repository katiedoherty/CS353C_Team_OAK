...
const overlaystyles ={
  ...
  const [cards, setCards] = useState("");
    ...
    useEffect(()=>{
      axios.get(`http://localhost:8080/api/usercards/${useremail}`).then((response)=>{
...
<div >
   ...
   <tr >
   <td>Ramsay Complements Your Food</td>
   ...
   <tr>
   <td>Push Your Opponents Food Off The Table</td>
     <td>{personscards?.WildCards?.pushyouropponentsfoodoffthetable}</td>
   </tr>
...
<button className="closeButton" onClick ={() => close(false)}><b>close</b></button> 
</div>
